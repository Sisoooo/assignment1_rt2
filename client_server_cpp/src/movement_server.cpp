...
namespace client_server_cpp{
  ...
  class MovementServer : public rclcpp::Node{
    public:
      ...
      MovementServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions())
      : Node("movement_server", options), current_x_(0.0), current_y_(0.0), current_theta_(0.0)
      {
...
RCLCPP_COMPONENTS_REGISTER_NODE(client_server_cpp::MovementServer)
